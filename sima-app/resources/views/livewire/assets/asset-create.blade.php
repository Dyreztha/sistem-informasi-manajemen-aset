            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" id="name" wire:model="name" class="w-full bg-white border-gray-300 text-gray-900 placeholder-gray-400 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500" placeholder="Contoh: Laptop Thinkpad X1">
                    ...
                    <div>
                        ...
                        <select id="category_id" wire:model="category_id" class="w-full bg-white border-gray-300 text-gray-900 rounded-xl focus:border-blue-500 focus:ring-blue-500 cursor-pointer hover:ring-2 hover:ring-blue-500">
                    ...
                    <div>
                        ...
                        <select id="location_id" wire:model="location_id" class="w-full bg-white border-gray-300 text-gray-900 rounded-xl focus:border-blue-500 focus:ring-blue-500 cursor-pointer hover:ring-2 hover:ring-blue-500">
                    ...
                    <div>
                        ...
                        <input type="text" id="brand" wire:model="brand" class="w-full bg-white border-gray-300 text-gray-900 placeholder-gray-400 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500" placeholder="Contoh: Lenovo">
                    </div>

                    <!-- Model -->
                    <div>
                        <label for="model" class="block text-sm font-medium text-gray-700 mb-2">Tipe/Model</label>
                        <input type="text" id="model" wire:model="model" class="w-full bg-white border-gray-300 text-gray-900 placeholder-gray-400 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500" placeholder="Contoh: X1 Carbon Gen 9">
                    </div>

                    <!-- Serial Number -->
                    <div>
                        <label for="serial_number" class="block text-sm font-medium text-gray-700 mb-2">Nomor Seri</label>
                        <input type="text" id="serial_number" wire:model="serial_number" class="w-full bg-white border-gray-300 text-gray-900 placeholder-gray-400 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500" placeholder="Serial Number">
                    </div>

                    <!-- Vendor -->
                    <div>
                        <label for="vendor_id" class="block text-sm font-medium text-gray-700 mb-2">Vendor</label>
                        <select id="vendor_id" wire:model="vendor_id" class="w-full bg-white border-gray-300 text-gray-900 rounded-xl focus:border-blue-500 focus:ring-blue-500 cursor-pointer hover:ring-2 hover:ring-blue-500">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" id="purchase_date" wire:model="purchase_date" class="w-full bg-white border-gray-300 text-gray-900 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500">
                    </div>

                    <!-- Warranty End -->
                    <div>
                        <label for="warranty_end_date" class="block text-sm font-medium text-gray-700 mb-2">Garansi Sampai</label>
                        <input type="date" id="warranty_end_date" wire:model="warranty_end_date" class="w-full bg-white border-gray-300 text-gray-900 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select id="status" wire:model="status" class="w-full bg-white border-gray-300 text-gray-900 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500 cursor-pointer">
                    ...
                    <div>
                        ...
                        <select id="condition" wire:model="condition" class="w-full bg-white border-gray-300 text-gray-900 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500 cursor-pointer">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" wire:model="description" rows="3" class="w-full bg-white border-gray-300 text-gray-900 placeholder-gray-400 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500" placeholder="Deskripsi detail aset..."></textarea>
                    </div>

                    <!-- Notes -->
                    <div>
                        <label for="notes" class="block text-sm font-medium text-gray-700 mb-2">Catatan</label>
                        <textarea id="notes" wire:model="notes" rows="2" class="w-full bg-white border-gray-300 text-gray-900 placeholder-gray-400 rounded-xl focus:border-blue-500 focus:ring-blue-500 hover:ring-2 hover:ring-blue-500" placeholder="Catatan tambahan..."></textarea>
                    </div>
                </div>
            </div>
