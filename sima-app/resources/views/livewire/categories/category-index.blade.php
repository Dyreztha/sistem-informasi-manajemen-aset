                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                            @can('edit-categories')
                            <button wire:click="openEditModal({{ $category->id }})" class="p-2 rounded-lg text-gray-500 hover:text-amber-600 hover:bg-gray-100 transition-colors hover:translate-y-[-1px]">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button wire:click="confirmDelete({{ $category->id }})" class="p-2 rounded-lg text-gray-500 hover:text-red-600 hover:bg-gray-100 transition-colors hover:translate-y-[-1px]">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
