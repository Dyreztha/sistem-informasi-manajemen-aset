...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-gray-50">
        <div class="min-h-screen">
            ...
            <!-- Hero Section -->
            <div class="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-white">
                <div class="relative max-w-7xl mx-auto text-center">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        <a href="{{ route('login') }}" class="px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-semibold shadow-sm transition-all duration-300">
                            Mulai Sekarang
                        </a>
                        <a href="#features" class="px-8 py-4 bg-white text-gray-700 rounded-xl font-semibold border border-gray-300 hover:bg-gray-50 transition-all duration-300">
            ...
            <!-- Features Section -->
            <div id="features" class="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
                <div class="max-w-7xl mx-auto">
                    ...
                    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <!-- Feature 1 -->
                        <div class="p-6 bg-white rounded-2xl border border-gray-200 hover:border-blue-300 transition-colors shadow-sm">
                        ...
                        <!-- Feature 2 -->
                        <div class="p-6 bg-white rounded-2xl border border-gray-200 hover:border-emerald-300 transition-colors shadow-sm">
                        ...
                        <!-- Feature 3 -->
                        <div class="p-6 bg-white rounded-2xl border border-gray-200 hover:border-amber-300 transition-colors shadow-sm">
                        ...
                        <!-- Feature 4 -->
                        <div class="p-6 bg-white rounded-2xl border border-gray-200 hover:border-rose-300 transition-colors shadow-sm">
                        ...
                        <!-- Feature 5 -->
                        <div class="p-6 bg-white rounded-2xl border border-gray-200 hover:border-purple-300 transition-colors shadow-sm">
                        ...
                        <!-- Feature 6 -->
                        <div class="p-6 bg-white rounded-2xl border border-gray-200 hover:border-cyan-300 transition-colors shadow-sm">
